...
@test "change php to 8.1" {
  ...
  source ~/.phpbrew/bashrc
  run php -v
  assert_line --partial "PHP 8.1."
  run php -m
  assert_line --partial "gd"
  assert_line --partial "imap"
  run which composer
  assert_success
  assert_line --partial "8.1."
...
@test "change php to 8.2" {
  ...
  source ~/.phpbrew/bashrc
  run php -v
  assert_line --partial "PHP 8.2."
  run php -m
  assert_line --partial "gd"
  assert_line --partial "imap"
  run which composer
  assert_success
  assert_line --partial "8.2."
  run phpbrew ext install iconv
  assert_success
}
...
@test "change php to 8.3" {
  ...
  source ~/.phpbrew/bashrc
  run php -v
  assert_line --partial "PHP 8.3."
  run php -m
  assert_line --partial "gd"
  assert_line --partial "imap"
  run which composer
  assert_success
  assert_line --partial "8.3."
  run phpbrew ext install iconv
  assert_success
}
...
@test "change php to 8.4" {
  ...
  source ~/.phpbrew/bashrc
  run php -v
  assert_line --partial "PHP 8.4."
  run php -m
  assert_line --partial "gd"
  run which composer
  assert_success
  assert_line --partial "8.4."
  run phpbrew ext install iconv
  assert_success
}
