...
@test "change erlang to 26.1" {
  sem-version erlang 26.1
  run erl -eval 'erlang:display(erlang:system_info(otp_release)), halt().'  -noshell
  assert_line --partial "26"
}
...
@test "change erlang to 27.0" {
  sem-version erlang 27.0
  run erl -eval 'erlang:display(erlang:system_info(otp_release)), halt().'  -noshell
  assert_line --partial "27"
}

@test "change erlang to 27.1" {
  sem-version erlang 27.1
  run erl -eval 'erlang:display(erlang:system_info(otp_release)), halt().'  -noshell
  assert_line --partial "27"
}
...
@test "change erlang to 28.2" {
  sem-version erlang 28.2
  run erl -eval 'erlang:display(erlang:system_info(otp_release)), halt().'  -noshell
  assert_line --partial "28"
}

@test "change erlang to 28.3" {
  sem-version erlang 28.3
  run erl -eval 'erlang:display(erlang:system_info(otp_release)), halt().'  -noshell
  assert_line --partial "28"
}

@test "change erlang to 28.4" {
  sem-version erlang 28.4
  run erl -eval 'erlang:display(erlang:system_info(otp_release)), halt().'  -noshell
  assert_line --partial "28"
}

@test "change erlang to 28.5" {
  sem-version erlang 28.5
  run erl -eval 'erlang:display(erlang:system_info(otp_release)), halt().'  -noshell
  assert_line --partial "28"
}

@test "change erlang to 29.0" {
  sem-version erlang 29.0
  run erl -eval 'erlang:display(erlang:system_info(otp_release)), halt().'  -noshell
